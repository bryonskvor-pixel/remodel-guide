...
const PRODUCTS = {
  ...
  hardware: [
    ...
    { id: 'knob-brass',  label: 'Brass Knob',  desc: 'Franklin Brass · Champagne Bronze mushroom knob', imageUrl: 'https://cdn.shopify.com/s/files/1/0925/5164/3418/files/1280_Iigpk92zVYp39wWw.png?v=1757517086', prompt: 'small round dome-shaped mushroom knobs in warm champagne bronze gold finish — centered on every cabinet door and drawer front, no bar pulls or old hardware' },
    { id: 'knob-nickel', label: 'Nickel Knob', desc: 'Franklin Brass · Satin Nickel mushroom knob',    imageUrl: 'https://cdn.shopify.com/s/files/1/0925/5164/3418/files/1280_sYfoiaMyxHJ02ADs.png?v=1757517086', prompt: 'small round dome-shaped mushroom knobs in brushed satin nickel finish — centered on every cabinet door and drawer front, no bar pulls or old hardware' },
    { id: 'knob-black',  label: 'Black Knob',  desc: 'Franklin Brass · Matte Black mushroom knob',     imageUrl: 'https://cdn.shopify.com/s/files/1/0925/5164/3418/files/1280_IwyQIIQEYL551IXh.png?v=1757517086', prompt: 'small round dome-shaped mushroom knobs in matte black finish — centered on every cabinet door and drawer front, no bar pulls or old hardware' },

    // PULLS — Liberty Phoebe Pull (3")
    { id: 'pull-brass',  label: 'Brass Pull',  desc: 'Liberty Phoebe · Modern Gold 3" bar pull',       imageUrl: 'https://cdn.shopify.com/s/files/1/0925/5164/3418/files/1280_IsNfPAb6eb71ItUv.png?v=1779991059', prompt: 'slim straight bar pulls in warm champagne bronze gold finish — mounted horizontally on every drawer front and vertically on every cabinet door, no knobs or old hardware' },
    { id: 'pull-nickel', label: 'Nickel Pull', desc: 'Liberty Phoebe · Satin Nickel 3" bar pull',      imageUrl: 'https://cdn.shopify.com/s/files/1/0925/5164/3418/files/P33746C-SN-C.jpg?v=1780932581',          prompt: 'slim straight bar pulls in brushed satin nickel finish — mounted horizontally on every drawer front and vertically on every cabinet door, no knobs or old hardware' },
    { id: 'pull-black',  label: 'Black Pull',  desc: 'Liberty Phoebe · Matte Black 3" bar pull',       imageUrl: 'https://cdn.shopify.com/s/files/1/0925/5164/3418/files/1280_EuvxLzeeL4651YZk.png?v=1779991114', prompt: 'slim straight bar pulls in matte black finish — mounted horizontally on every drawer front and vertically on every cabinet door, no knobs or old hardware' },
  ],
